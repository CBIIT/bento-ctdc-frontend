...
import {
  SEARCH_PAGE_RESULT_ARMS,
  SEARCH_PAGE_RESULT_FILES,
  SEARCH_PAGE_RESULT_MODEL,
  SEARCH_PAGE_RESULT_ABOUT,
  SEARCH_PAGE_RESULT_CLINICAL_TRIALS,
  SEARCH_PAGE_RESULT_CASES,
} from '../../../bento/search';
...
function SearchPagination({
  ...
  async function getAll(newPage, calcOffset) {
    ...
    const custodianConfigForTabData = [
      ...
      { countField: 'arm_count', nameField: 'arms' },
      { countField: 'clinical_trial_count', nameField: 'clinical_trials' },
  ...
  function getQuery(field) {
    switch (field) {
      case 'all':
        return { QUERY: SEARCH_PAGE_RESULT_CLINICAL_TRIALS, field: 'all' };
      case 'cases':
        return { QUERY: SEARCH_PAGE_RESULT_CASES, field: 'cases' };
      case 'files':
        return { QUERY: SEARCH_PAGE_RESULT_FILES, field: 'files' };
      case 'arms':
        return { QUERY: SEARCH_PAGE_RESULT_ARMS, field: 'arms' };
      case 'clinical_trials':
        return { QUERY: SEARCH_PAGE_RESULT_CLINICAL_TRIALS, field: 'clinical_trials' };
      case 'model':
